...
export function registerAllHandlers() {
  ...
  ipcMain.on("screenshareDebug:shouldInjectWasapiTransport", (event) => { event.returnValue = ___modules_screenshareDebug_shouldInjectWasapiTransport(); });
